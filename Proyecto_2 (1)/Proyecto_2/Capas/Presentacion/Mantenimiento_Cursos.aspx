<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Mantenimiento_Cursos.aspx.cs" Inherits="Proyecto_2.Capas.Presentacion.Mantenimiento_Cursos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	<body style="background-color:dimgray; color:white">
<div>
    <h3 style="color:#0B4C89">
            <asp:Label ID="Label1" runat="server" Text="MANTENIMIENTO DE CURSOS"></asp:Label><br/><br/><h3 />
            ...
            <asp:Panel ID="PanelAgregar" runat="server" Visible="false">
                <asp:Label ID="Label8" runat="server" Text="Agregar Curso"></asp:Label>
                <br/><br/>
               ...
               <asp:DropDownList id="ddl_IdEscuela" runat="server" AutoPostBack="true" ></asp:DropDownList>
                <br/>
				<br />
                <asp:Label ID="Label3" runat="server" Text="Nombre del curso:"></asp:Label>
                ...
                <br/>
                <br/>
                <asp:Button ID="btnInsertarCurso" runat="server" Text="Insertar curso" OnClick="btnInsertarCurso_Click" /> ||
                <asp:Button ID="btnInsertarCurso_Cancelar" runat="server" Text="Cancelar" OnClick="btnInsertarCurso_Cancelar_Click" />
            </asp:Panel>
            <!--PANEL PARA EDITAR-->
            <asp:Panel ID="PanelEditar" runat="server" Visible="false">
                 <asp:Label ID="Label9" runat="server" Text="Editar Curso"></asp:Label>
                 <br/><br/>
                 <asp:Label ID="Label10" runat="server" Text="Cursos"></asp:Label>
                 <asp:DropDownList id="ddl_Cursos" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_Cursos_SelectedIndexChanged"></asp:DropDownList>
                             <br/>
                             <br/>          
				              <br />
                    ...
                    <br/>
				<br />
                    <asp:Label ID="Label13" runat="server" Text="Nombre del curso:"></asp:Label>
                    <asp:TextBox ID="TxtEditar_NombreCurso" runat="server"></asp:TextBox>
                    <br/>
				<br />
                ...
                <br/>
                <asp:Button ID="btnEditar" runat="server" Text="Editar Curso" OnClick="btnEditar_Click" /> ||
        ...
        <br/>
            ...
            <asp:Panel ID="PanelEliminar"  runat="server" Visible="false">
                 <asp:Label ID="Label17" runat="server" Text="Eliminar Curso"></asp:Label>
                 <br/><br/>
                 <asp:Label ID="Label18" runat="server" Text="Cursos"></asp:Label>
                 <asp:DropDownList id="ddl_EliminarCurso" runat="server" AutoPostBack="true"></asp:DropDownList>
                <br/>
                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar Cursos" OnClick="btnEliminar_Click" /> ||
            ...
            <asp:Panel ID="PanelConsultar" runat="server" Visible="false">
                 <asp:Label ID="Label19" runat="server" Text="Consultar Cursos"></asp:Label>
                 <br/><br/>
                 <asp:GridView ID="GVCursos" runat="server" style="width:100%;" HeaderStyle-BackColor="#F7990D" Font-Size="Medium" HeaderStyle-ForeColor="White" >
                 </asp:GridView>
                 <br/>
				<br />
